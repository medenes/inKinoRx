class TMDBConfig {
  /// rename this file to `tmdb_config.dart` before building
  /// The TMDB API is mostly used for loading actor avatars.
  /// 
  /// you can get your own key here https://www.themoviedb.org/ 
  ///
  ...
  static final String apiKey = 'b344d45774ed78fc414729bace0504a2';
}